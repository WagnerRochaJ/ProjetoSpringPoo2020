...
public class ProjetoSpringPooApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente("Maria Silva", "maria@gmail.com",
			"321654987",TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("64983412","35874910"));
		
		Endereco e1 = new Endereco("Rua Flore","300","apt 303","Jardim","654321-98",cli1,c1);
		Endereco e2 = new Endereco("Av Matos","105","sal 800","Centro","951354-54",cli1,c2);
